...
-- Thiết lập lại các biến môi trường
...
-- Thêm 20 người dùng mới (PersonId 75-94)
...
-- *******************************************************
-- 3. BẢNG NGƯỜI GIÁM HỘ (NGUOIGIAMHO)
-- *******************************************************
...
-- Thêm 10 bản ghi mới (MaGiamHo 11-20)
...
-- *******************************************************
-- 4. BẢNG BÁC SĨ (BACSI) - Đã đủ > 30 bản ghi
-- *******************************************************
...
-- Thêm 10 bản ghi mới (Sử dụng PersonId 85-94 và MaGiamHo 11-20)
...
-- *******************************************************
-- 6. BẢNG DỊCH VỤ Y TẾ (DICHVUYTE) - Đã đủ > 20 bản ghi
-- *******************************************************
...
-- *******************************************************
-- 7. BẢNG LOẠI THUỐC (LOAITHUOC) - Đã đủ > 30 bản ghi
-- *******************************************************
...
-- *******************************************************
-- 8. BẢNG ĐƠN THUỐC (DONTHUOC) - Đã đủ > 40 bản ghi
-- *******************************************************
...
-- *******************************************************
-- 9. BẢNG PHIẾU DỊCH VỤ (PHIEUDICHVU) - Đã đủ > 30 bản ghi
-- *******************************************************
...
-- *******************************************************
-- 10. BẢNG HỒ SƠ BỆNH ÁN (HOSOBENHAN)
-- *******************************************************
...
-- Thêm 10 bản ghi mới (sử dụng MaBenhNhan 34-43)
...
-- *******************************************************
-- 11. BẢNG LỊCH SỬ KHÁM (LICHSUKHAM)
-- *******************************************************
...
-- Thêm 10 bản ghi mới (sử dụng MaHoSo 32-41)
...
-- *******************************************************
-- 12. BẢNG ĐẶT LỊCH KHÁM (DATLICHKHAM)
-- *******************************************************
...
-- *******************************************************
-- 13. BẢNG KÊ ĐƠN (KEDON) - Đã đủ > 40 bản ghi
-- *******************************************************
